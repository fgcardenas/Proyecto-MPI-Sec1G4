	...
	<section class="full-width container-notifications">
	    ...
	    <section class="NotificationArea">
	        ...
	        <a href="#" class="Notification" id="notifation-unread-1">
	        	...
	        	<div class="mdl-tooltip mdl-tooltip--left" for="notifation-unread-1"> Notificacion no leida</div> 
	        </a>
	        <a href="#" class="Notification" id="notifation-read-1">
	            ...
	            <div class="mdl-tooltip mdl-tooltip--left" for="notifation-read-1">Notificacion leida</div>
	        </a>
	        <a href="#" class="Notification" id="notifation-unread-2">
	            ...
	            <div class="mdl-tooltip mdl-tooltip--left" for="notifation-unread-2">Notificaciones no leidas</div>
	        </a> 
